...
public class UtilityFunctions {
	...
	public static void SetDefaultValues()
	{
		...
		PropertiesAndConstants.EvnFilePath = PropertiesAndConstants.CurrentDirectory+"/macbook/Documents/"+"iprogrammerAutomation/Config/Env.xml";
	...
	public static void CaptureExecutionResults(Workbook testScript,Sheet testScriptSheet, int rowID, boolean result, String resultsToExcel) throws IOException, WriteException
	{
        ...
        testscriptcopy=Workbook.createWorkbook(new File("/Users/macbook/Documents/iprogrammerAutomation/result"+".xls"),testScript);
